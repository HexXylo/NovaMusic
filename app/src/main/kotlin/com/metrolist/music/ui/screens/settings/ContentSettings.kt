...
import com.novamusic.app.constants.ContentCountryKey
import com.novamusic.app.constants.ContentLanguageKey
import com.novamusic.app.constants.CountryCodeToName
...
import com.novamusic.app.constants.EnablePaxsenixKey
import com.novamusic.app.constants.EnableLyricsPlus
...
import com.novamusic.app.constants.LanguageCodeToName
import com.novamusic.app.constants.LyricsProviderOrderKey
import com.novamusic.app.constants.ProxyEnabledKey
import com.novamusic.app.constants.ProxyPasswordKey
import com.novamusic.app.constants.ProxyTypeKey
import com.novamusic.app.constants.ProxyUrlKey
import com.novamusic.app.constants.ProxyUsernameKey
import com.novamusic.app.constants.QuickPicks
import com.novamusic.app.constants.QuickPicksKey
import com.novamusic.app.constants.RandomizeHomeOrderKey
import com.novamusic.app.constants.SYSTEM_DEFAULT
import com.novamusic.app.constants.ShowArtistDescriptionKey
import com.novamusic.app.constants.ShowMostStatsPlaylistsKey
import com.novamusic.app.constants.ShowArtistSubscriberCountKey
import com.novamusic.app.constants.ShowMonthlyListenersKey
import com.novamusic.app.constants.ShowWrappedCardKey
import com.novamusic.app.constants.TopSize
...
import com.novamusic.app.ui.component.DraggableLyricsProviderItem
import com.novamusic.app.ui.component.DraggableLyricsProviderList
    ...
    LaunchedEffect(showMostStatsPlaylists) {
        if (!showMostStatsPlaylists) {
            database.withTransaction {
                clearPlaylist(com.novamusic.app.db.entities.PlaylistEntity.WEEKLY_MOST_PLAYLIST_ID)
                clearPlaylist(com.novamusic.app.db.entities.PlaylistEntity.MONTHLY_MOST_PLAYLIST_ID)
                delete(
                    com.novamusic.app.db.entities.PlaylistEntity(
                        id = com.novamusic.app.db.entities.PlaylistEntity.WEEKLY_MOST_PLAYLIST_ID,
                        name = "",
                    ),
                )
                delete(
                    com.novamusic.app.db.entities.PlaylistEntity(
                        id = com.novamusic.app.db.entities.PlaylistEntity.MONTHLY_MOST_PLAYLIST_ID,
                        name = "",
                    ),
                )
            }
