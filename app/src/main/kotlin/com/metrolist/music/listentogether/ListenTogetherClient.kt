...
package com.novamusic.app.listentogether
...
import com.novamusic.app.constants.ListenTogetherAutoApprovalKey
import com.novamusic.app.constants.ListenTogetherAutoApproveSuggestionsKey
import com.novamusic.app.constants.ListenTogetherIsHostKey
import com.novamusic.app.constants.ListenTogetherRoomCodeKey
import com.novamusic.app.constants.ListenTogetherServerUrlKey
import com.novamusic.app.constants.ListenTogetherSessionTimestampKey
import com.novamusic.app.constants.ListenTogetherSessionTokenKey
import com.novamusic.app.constants.ListenTogetherUserIdKey
...
class ListenTogetherClient
    ...
    constructor(
        ...
        companion object {
            ...
            const val ACTION_APPROVE_JOIN = "com.novamusic.app.LISTEN_TOGETHER_APPROVE_JOIN"
            const val ACTION_REJECT_JOIN = "com.novamusic.app.LISTEN_TOGETHER_REJECT_JOIN"
            const val ACTION_APPROVE_SUGGESTION = "com.novamusic.app.LISTEN_TOGETHER_APPROVE_SUGGESTION"
            const val ACTION_REJECT_SUGGESTION = "com.novamusic.app.LISTEN_TOGETHER_REJECT_SUGGESTION"
        ...
        private fun loadBlockedUsernames() {
            try {
                val blockedJson = context.dataStore.get(com.novamusic.app.constants.ListenTogetherBlockedUsersKey, "")
                val blockedList =
        ...
        private suspend fun saveBlockedUsernames() {
            try {
                ...
                context.dataStore.edit { preferences ->
                    preferences[com.novamusic.app.constants.ListenTogetherBlockedUsersKey] = blockedJson
                }
            } catch (e: Exception) {
