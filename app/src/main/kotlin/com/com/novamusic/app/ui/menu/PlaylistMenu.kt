...
import com.novamusic.app.ui.menu.ExportDialog
import com.novamusic.app.utils.PlaylistExporter
import com.novamusic.app.utils.getExportFileUri
import com.novamusic.app.utils.saveToPublicDocuments
    ...
    if (showExportDialog) {
        ExportDialog(
            ...
            onShare = { format ->
                val playlistSongs =
                    songs.map { s ->
                        com.novamusic.app.db.entities.PlaylistSong(
                            map =
                                com.novamusic.app.db.entities.PlaylistSongMap(
                                    songId = s.id,
